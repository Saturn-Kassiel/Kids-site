...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    // Читаем deep link — из ?s= (универсально) или start_param (Telegram) или хэша
    ...
    if (deepLinkMatch) {
        ...
        // Ждём полной инициализации данных
        await App.init();
        document.getElementById('loader').style.display = 'none';

        // Небольшая пауза чтобы ShareHelper успел перехватить App.navigate
