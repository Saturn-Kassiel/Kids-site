...
const SHELL_URLS = [
    ...
    '/Kids-site/js/core.js',
    '/Kids-site/js/answer-checker.js',
    '/Kids-site/js/sounds.js',
    '/Kids-site/js/gosha.js',
    '/Kids-site/js/audio-mgr.js',
    '/Kids-site/js/stat-tracker.js',
    '/Kids-site/js/achievements.js',
    '/Kids-site/js/badges.js',
    '/Kids-site/js/media.js',
    '/Kids-site/js/words.js',
    '/Kids-site/js/arithmetic.js',
    '/Kids-site/js/songs.js',
    '/Kids-site/js/podcasts.js',
    '/Kids-site/js/puzzles.js',
    '/Kids-site/js/riddles.js',
    '/Kids-site/js/info.js',
    '/Kids-site/js/stats.js',
    '/Kids-site/js/admin.js',
    '/Kids-site/js/interstitials.js',
    '/Kids-site/js/notif.js',
