...
const Words = {
    ...
    _data: {
        easy: [
            ...
            { word:'ТАЗ',  emoji:'🫧' }, { word:'ЛОМ',  emoji:'🔧' }, { word:'РОГ',  emoji:'🦌' },
            ...
            { word:'КОС',  emoji:'🌾' }, { word:'ЛОВ',  emoji:'🎣' }, { word:'ПАР',  emoji:'♨️' },
            { word:'ГАВ',  emoji:'🐶' }, { word:'ТОН',  emoji:'🎵' }, { word:'ЧАН',  emoji:'🪣' },
            { word:'РАЙ',  emoji:'☁️' }, { word:'ЙОД',  emoji:'💊' }, { word:'МЯУ',  emoji:'🐱' },
            { word:'ВОЗ',  emoji:'🚜' }, { word:'РОЙ',  emoji:'🐝' }, { word:'МАЛ',  emoji:'👶' },
            { word:'ЛЁН',  emoji:'🌾' }, { word:'УРА',  emoji:'🎉' }, { word:'КВАС', emoji:'🍺' },
            { word:'ПИЛ',  emoji:'🪚' }, { word:'ПУХ',  emoji:'🪶' },
            { word:'ВОС',  emoji:'🕯️' }, { word:'ГОД',  emoji:'📅' }, { word:'БОРЩ', emoji:'🥣' },
            { word:'ВОР',  emoji:'🦝' }, { word:'ЗОВ',  emoji:'📣' }, { word:'ВЕК',  emoji:'⏳' },
{ word:'РЯД',  emoji:'🪑' },
                        { word:'ЛУЧ',  emoji:'☀️' }, { word:'ГОЛ',  emoji:'⚽' }, { word:'МИГ',  emoji:'⚡' },
            { word:'ЛОСЬ', emoji:'🦌' },
        ],
        medium: [
